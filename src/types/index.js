...
export const OPTENER_PRODUCTO_ELIMINAR = 'OPTENER_PRODUCTO_ELIMINAR'
export const PRODUCTO_ELIMINAR_EXITO = 'PRODUCTO_ELIMINAR_EXITO'
export const PRODUCTO_ELIMINAR_ERROR = 'PRODUCTO_ELIMINAR_EXITO'

export const OPTENER_PRODUCTO_EDITAR = 'OPTENER_PRODUCTO_EDITAR'
